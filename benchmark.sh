...
python snn_batch_benchmark.py --encoding Poisson    --neuron_model DiehlAndCook --update_rule PostPre 
python snn_batch_benchmark.py --encoding Poisson    --neuron_model DiehlAndCook --update_rule WeightDependentPostPre 
python snn_batch_benchmark.py --encoding Poisson    --neuron_model DiehlAndCook --update_rule Hebbian 
...
python snn_batch_benchmark.py --encoding Bernoulli  --neuron_model DiehlAndCook --update_rule PostPre 
python snn_batch_benchmark.py --encoding Bernoulli  --neuron_model DiehlAndCook --update_rule WeightDependentPostPre 
python snn_batch_benchmark.py --encoding Bernoulli  --neuron_model DiehlAndCook --update_rule Hebbian 
...
python snn_batch_benchmark.py --encoding RankOrder  --neuron_model DiehlAndCook --update_rule PostPre 
python snn_batch_benchmark.py --encoding RankOrder  --neuron_model DiehlAndCook --update_rule WeightDependentPostPre 
python snn_batch_benchmark.py --encoding RankOrder  --neuron_model DiehlAndCook --update_rule Hebbian 
